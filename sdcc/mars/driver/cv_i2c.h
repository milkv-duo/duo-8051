...
#define BIT_I2C_CMD_DATA_WRITE_BIT           (0x00 << 8)
...
size_t i2c_dl_read_data(unsigned long lba, uintptr_t buf, size_t len);
void bm_i2c_init(unsigned long base, unsigned short addr);
...
void cv_i2c_pinmux_io_switch(uint8_t turn_on) __reentrant;
uint8_t cv_i2c_is_busy(void) __reentrant;
#endif	/* __CV_I2C_H__ */
